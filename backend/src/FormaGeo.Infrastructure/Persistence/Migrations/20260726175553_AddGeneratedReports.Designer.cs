...
namespace FormaGeo.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260726175553_AddGeneratedReports")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FormaGeo.Domain.Comparisons.SiteComparison", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<DateTimeOffset>("ComparisonDateUtc")
                        .HasColumnType("timestamp with time zone")
                    ...
                    b.HasIndex("ScoringScenarioId");

                    b.HasIndex("ProjectId", "ComparisonDateUtc");

                    b.ToTable("site_comparisons", (string)null);
                });
            ...
            modelBuilder.Entity("FormaGeo.Domain.Reports.GeneratedReport", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("ComparisonId", "GeneratedAtUtc");

                    b.HasIndex("ProjectId", "GeneratedAtUtc");

                    b.HasIndex("SiteId", "GeneratedAtUtc");
